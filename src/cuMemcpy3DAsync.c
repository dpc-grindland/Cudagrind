...
CUresult I_WRAP_SONAME_FNNAME_ZZ(libcudaZdsoZa, cuMemcpy3DAsync)(const CUDA_MEMCPY3D *pCopy, CUstream hStream) {
   int error = 0;
   long vgErrorAddress;
   ...
   if (vgErrorAddress) {
      error++;
      VALGRIND_PRINTF("Error: 'hStream' in call to cuMemcpy3DAsync not defined.\n");
   }
