...
/******************************************************************************
 *
 * Wrapper for cuMemsetD2D32Async
 *
...
CUresult I_WRAP_SONAME_FNNAME_ZZ(libcudaZdsoZa, cuMemsetD2D32Async)(CUdeviceptr dstDevice, size_t dstPitch, unsigned int ui, size_t Width, size_t Height, CUstream hStream) {
   int error = 0;
   long vgErrorAddress;
   ...
   if (vgErrorAddress) {
      error++;
      VALGRIND_PRINTF("Error: 'hStream' in call to cuMemsetD2D32Async not defined.\n");
   }
