...
/******************************************************************************
 *
 * Wraps the cuArray3DGetDescriptor function to compare 
 * returned errors with the internal list of 3D arrays.
 *
 ******************************************************************************/
#include <cudaWrap.h>
...
CUresult I_WRAP_SONAME_FNNAME_ZZ(libcudaZdsoZa, cuArray3DGetDescriptor)(CUDA_ARRAY3D_DESCRIPTOR *pArrayDescriptor, CUarray hArray) {
   OrigFn         fn;
   CUresult       result;
   CUcontext      ctx = NULL;
